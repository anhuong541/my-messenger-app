...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies_sveltefire: string;
	...
	export const npm_package_dependencies_nodemon: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies_sveltefire: string;
		...
		npm_package_dependencies_nodemon: string;
		NVM_BIN: string;
